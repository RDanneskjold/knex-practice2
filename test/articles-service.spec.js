...
describe('Articles service object', function() {
  ...
  context(`Given 'blogful_articles' has data`, () => {
      ...
      return ArticlesService.getById(db, thirdId)
        .then(actual => {
          expect(actual).to.eql({
            ...
            content: thirdTestArticle.title,
    ...
    it(`deleteArticle() removes an article by id from 'blogful_articles' table`, () => {
      ...
      return ArticlesService.deleteArticle(db, articleId)
        ...
        .then(allArticles => {
          const expected = testArticles.filter(article => article.article_id !== articleId)
    ...
    it(`updateArticle() updates an article from the 'blogful_articles' table`, () => {
      ...
      return ArticlesService.updateArticle(db, updateId, newArticleData)
  ...
  context(`Given 'blogful_articles' has no data`, () => {
    it(`getAllArticles() reolves an empty array`, () => {
      return ArticlesService.getAllArticles(db)
        .then(actual => {
          expect(actual).to.eql([])
        })
